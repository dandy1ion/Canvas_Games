...
class Enemy {
	constructor() {
		...
		this.interval = Math.floor(Math.random() * 200 + 50); //between 50 & 250
		//gives each enemy own reset/rythm
	}
	update() {
		//interval (when reset to new position)
		...
		// this.x -= dx;
		// this.y -= dy;
		//increase these numbers to move slower
		this.x -= dx / 20;
		this.y -= dy / 20;
